...
// Fetch results based on the current filter, now including student's name
$results_stmt = $pdo->prepare("
    SELECT r.id, u.name as student_name, u.email, e.title, r.score, e.total_marks, r.submitted_at
    FROM results r
                ...
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        <?php if (empty($results)): ?>
                            <tr><td colspan="6" class="text-center py-4">No results found for the selected filter.</td></tr>
                        <?php else: ?>
