...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->fetch()) {
        ...
        try {
            ...
            $mail->Body = "Dear " . htmlspecialchars($name) . ",<br><br>Thank you for registering. Your verification code is: <b>$code</b><br><br>This code will expire in 10 minutes.<br><br>Best regards,<br>The Exam Portal Team";
            $mail->send();

            $message = '<div class="alert alert-success">Registration successful! A verification email has been sent. Redirecting you now...</div>';
            $redirect_script = "<script>setTimeout(function() { window.location.href = 'verify.php?email=" . urlencode($email) . "'; }, 3000);</script>";
